...
from tensorflow.keras.layers import Input, Dense, LSTM, Dropout, Bidirectional, TimeDistributed, Activation, Dot, Concatenate, Reshape
import numpy as np
...
def load_and_train_model(X_train,y_train,X_test,y_test,model_type):
    ...
    if model_type=='lstm':
        ...
        # Reshape the first tensor to match the shape of the second tensor along the concatenation axis
        context = Reshape((context.shape[1], context.shape[2]*2))(context)
